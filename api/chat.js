  ...
  try {
    ...
    const body = {
      ...
      messages: [
        {
          role: 'system',
          content: 'Ты — финансовый помощник приложения MoneyPilot. Анализируй данные пользователя и отвечай на вопросы по делу, кратко, на русском. Данные пользователя передаются в каждом сообщении автоматически.',
        },
        {
          role: 'user',
