...
export default function FamilyPage() {
  ...
  const [showContributionDetailsFor, setShowContributionDetailsFor] = useState<string | null>(null);
  const [showContributionSharesFor, setShowContributionSharesFor] = useState<string | null>(null);
